//  Code Breaker 2020
// a new code breaking simulation which relies on human expertise to detect these low tech scrambled keywords.
...
int main()
{
	...
	do {
		...
		cout << "\t\t\tWelecome to Code Breaker 2020\n\n";
		...
		for (int j = 1; j <= 3; j++) {
			...
			{"supercalifragilisticexpialidocious", "Marry Poppins favorite word"},
			{"facebook", "The lisard man rules this."},
			{"oculus", "A Vr Headset."},
			{"heart", "A vital organ"}
			};
